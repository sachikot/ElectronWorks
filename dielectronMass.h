...
// Mon Jun  8 23:37:56 2015 by ROOT version 5.34/18
// from TTree EventTree/Event data
// found on file: TTree_DY.root
//////////////////////////////////////////////////////////

#ifndef dielectronMass_h
#define dielectronMass_h
...
public :
   ...
   dielectronMass(TTree *tree=0);
   virtual ~dielectronMass();
...
#ifdef dielectronMass_cxx
dielectronMass::dielectronMass(TTree *tree) : fChain(0) 
{
...
Int_t dielectronMass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dielectronMass::LoadTree(Long64_t entry)
{
...
void dielectronMass::Init(TTree *tree)
{
...
void dielectronMass::Show(Long64_t entry)
{
...
Int_t dielectronMass::Cut(Long64_t entry)
{
...
#endif // #ifdef dielectronMass_cxx
